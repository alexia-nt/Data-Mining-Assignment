...
for ngram_range in ngram_ranges:
    print(f"\n------------ Testing ngram_range={ngram_range} (BOW + Decision Tree) ------------")
    ...
    # Save results
    file_name = f"classification_tree_{'unigrams' if ngram_range == (1, 1) else 'bigrams'}_bow.txt"
    with open(os.path.join(RESULTS_DIR, file_name), "w", encoding="utf-8") as f:
